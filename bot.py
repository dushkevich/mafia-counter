...
def _build_conv_handler() -> ConversationHandler:
    ...
    return ConversationHandler(
        ...
        states={
            ...
            MARK_ALIVE_DEAD: [
                CallbackQueryHandler(toggle_alive, pattern=r"^alive_toggle:"),
                CallbackQueryHandler(alive_done, pattern=r"^alive_done$"),
            ],
            ADJUST_BONUSES: [
                CallbackQueryHandler(adjust_select, pattern=r"^adj_select:"),
                CallbackQueryHandler(adjust_delta, pattern=r"^adj_delta:"),
                CallbackQueryHandler(adjust_back, pattern=r"^adj_back$"),
                CallbackQueryHandler(adjust_done, pattern=r"^adj_done$"),
            ],
            FINISH_GAME: [
